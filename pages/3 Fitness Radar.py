...
# READ DATA
df = pd.read_csv('https://raw.githubusercontent.com/Galfishman/StatsBomb-Data/refs/heads/main/pages/InVenue%20Fitness.csv', encoding='utf-8', error_bad_lines=False)
...
selected_params = st.sidebar.multiselect(
    "Select Parameters:",
    options=all_params,
    default=("DistanceRun", "WalkDist", "RunDist", "SprintDist", "SprintCount"))  # Default value is all_params (all parameters selected)

params = selected_params

with st.expander("Show Players Table"):
    # Display the DataFrame with only selected parameters
    selected_columns = ['Player','teamName','Min'] + selected_params
